...
REM linking
arm-none-eabi-gcc %LIB_PATH% -nostartfiles -g -Wl,--no-gc-sections -Wl,-Map,Blinky.map -Wl,-T linkBlinkySTM32F4_01.ld -oBlinky.elf aStartup.o cMain.o cSys32.o -lgcc -lstdperiph
